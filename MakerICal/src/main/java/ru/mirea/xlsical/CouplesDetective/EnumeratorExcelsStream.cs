...
{
    public class EnumeratorExcelsStream : IEnumerator<ExcelFileInterface>
    {
        public EnumeratorExcelsStream(IEnumerable<Stream> excelFiles, bool needIngoreErrors = true)
        {
            enumeratorOfExcels = excelFiles.GetEnumerator();
            NeedIngoreErrors = needIngoreErrors;
        }

        private readonly IEnumerator<Stream> enumeratorOfExcels;
